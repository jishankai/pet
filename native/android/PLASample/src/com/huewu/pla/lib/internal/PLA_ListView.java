...
public class PLA_ListView extends PLA_AbsListView {
    ...
    public PLA_ListView(Context context, AttributeSet attrs, int defStyle) {
        ...
        final Drawable osHeader = a.getDrawable(R.styleable.ListView_overScrollHeader1);
        if (osHeader != null) {
            setOverscrollHeader(osHeader);
        }

        final Drawable osFooter = a.getDrawable(R.styleable.ListView_overScrollFooter1);
        if (osFooter != null) {
