...
import com.aidigame.hisun.pet.huanxin.InviteMessage.InviteMesageStatus;
...
//		EMGroupManager.getInstance().addGroupChangeListener(new MyGroupChangeListener());
	...
	public int getUnreadAddressCountTotal() {
		...
		if (com.aidigame.hisun.pet.PetApplication.getContactList().get(Constant.NEW_FRIENDS_USERNAME) != null)
			unreadAddressCountTotal = com.aidigame.hisun.pet.PetApplication.getContactList().get(Constant.NEW_FRIENDS_USERNAME).getUnreadMsgCount();
...
//			message.getStringAttribute("");
	...
	private class MyContactListener implements EMContactListener {
		...
		public void onContactAdded(List<String> usernameList) {
			// 保存增加的联系人
			Map<String, User> localUsers = com.aidigame.hisun.pet.PetApplication.getContactList();
	...
	private void saveInviteMsg(InviteMessage msg) {
		...
		// 未读数加1
		User user = com.aidigame.hisun.pet.PetApplication.getContactList().get(Constant.NEW_FRIENDS_USERNAME);
