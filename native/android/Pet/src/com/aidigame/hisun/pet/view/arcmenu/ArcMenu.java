...
package com.aidigame.hisun.pet.view.arcmenu;
...
public class ArcMenu extends RelativeLayout {
    ...
    ArcMenu arcMenu2;
    public void setInvisible(boolean flag,ArcMenu arcMenu2){
    	isInvisible=flag;
    	this.arcMenu2=arcMenu2;
    }
    ...
    private void init(Context context) {
       ...
       /* controlLayout.setOnTouchListener(new OnTouchListener() {
        ...
        mHintView = (CircleView) findViewById(R.id.control_hint);
    }
