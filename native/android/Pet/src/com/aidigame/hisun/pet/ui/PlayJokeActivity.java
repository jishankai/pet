 ...
 *
 */
public class PlayJokeActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
    	...
    	setContentView(R.layout.activity_play_joke);
...
//			titleTv.setText("捣捣乱");
		...
		cloudIV1.setImageResource(R.drawable.cloud_deep_blue);
		cloudIV2.setImageResource(R.drawable.cloud_deep_blue);
		TextView tv2=(TextView)view1.findViewById(R.id.textView2);
		tv2.setText("小鬼捣捣乱，措手不及减人气");
		ImageView iv1=(ImageView)view1.findViewById(R.id.imageView1);
		iv1.setImageResource(R.drawable.play_play_joke);
	...
	public void initView2(final Gift gift){
		...
		RelativeLayout giftBackLayout=(RelativeLayout)view2.findViewById(R.id.imageView1);
		giftBackLayout.setBackgroundResource(R.drawable.play_joke_gift_background);
		gift.is_shake=true;
		...
		awardNameTv.setText(gift.name+"x1");
		awardNameTv.setTextColor(getResources().getColor(R.color.white));
...
public void initView4(){
	...
	cloudIV1.setImageResource(R.drawable.cloud_deep_blue);
	cloudIV2.setImageResource(R.drawable.cloud_deep_blue);
	cloudIV3.setImageResource(R.drawable.cloud_deep_blue);
    ...
    TextView tv2=(TextView)view4.findViewById(R.id.textView2);
    TextView tv23=(TextView)view4.findViewById(R.id.textView23);
    TextView tv234=(TextView)view4.findViewById(R.id.textView234);
    tv234.setVisibility(View.INVISIBLE);
    tv2.setText("哈哈，上天没给你机会");
    tv23.setText("恶作剧不是每一个人都可以哟~");
}
    public void initView5(){
    	...
    	StringUtil.viewStartTransAnim(cloudIV2, 5000, -20, 20+Constants.screen_width);
    	StringUtil.viewStartTransAnim(cloudIV3, 4800, 20, -20-Constants.screen_width);
    	TextView tv2=(TextView)view5.findViewById(R.id.textView2);
        TextView tv23=(TextView)view5.findViewById(R.id.textView23);
        TextView tv234=(TextView)view5.findViewById(R.id.textView234);
       
        tv2.setText("够了~你真是够了！");
        tv23.setText("你今天的捣捣乱次数用完啦~");
        tv234.setText("换个宠物继续捣乱吧~");
    }
		...
		weixinIV.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if(Constants.api==null){
					boolean flag=WeixinShare.regToWeiXin(PlayJokeActivity.this);
					if(!flag){
						Toast.makeText(PlayJokeActivity.this,"目前您的微信版本过低或未安装微信，安装微信才能使用。", Toast.LENGTH_LONG).show();
...
//						Toast.makeText(this,"成功分享到微信。", Toast.LENGTH_LONG).show();
						...
						Toast.makeText(PlayJokeActivity.this,"分享失败。", Toast.LENGTH_LONG).show();
					}
			...
			public void onClick(View v) {
				...
				try {
					...
					if(WeixinShare.shareBitmap(data, 2)){
						Toast.makeText(PlayJokeActivity.this,"成功分享到微信。", Toast.LENGTH_LONG).show();
					}else{
						Toast.makeText(PlayJokeActivity.this,"分享到微信失败。", Toast.LENGTH_LONG).show();
					}
				} catch (FileNotFoundException e) {
					// TODO Auto-generated catch block
					e.printStackTrace();
