...
import com.aidigame.hisun.pet.widget.fragment.NineGiftBox;
import com.aidigame.hisun.pet.widget.fragment.NineGiftBox.SendGiftResultListener;
 ...
 *
 */
public class DialogGiveSbGiftActivity extends Activity{
	...
	ImageView closeIV;
	public static DialogGiveSbGiftActivity dialogGiveSbGiftActivity;
	...
	private void initView() {
		...
		closeIV.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				DialogGiveSbGiftActivity.this.finish();
				if(dialogGoListener!=null){
	...
	private void loadData() {
		...
		if(Constants.user!=null){
			 new Thread(new Runnable() {
					...
					public void run() {
						// TODO Auto-generated method stub
						final ArrayList<Gift> temp1=HttpUtil.userItems(DialogGiveSbGiftActivity.this,Constants.user, -1, handleHttpConnectionException.getHandler(context));
	...
	public void giftNumChange(final ArrayList<Gift> giftList){
		...
		for(int i=0;i<giftList.size();i++){
			if(i%9==0){
				if(i!=0){
					NineGiftBox ngb=new NineGiftBox(context, tempList,progressLayout);
