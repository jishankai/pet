...
import com.aidigame.hisun.imengstar.ui.PetTrendsActivity;
...
public class KingdomTrendsListAdapter extends BaseAdapter {
	...
	public KingdomTrendsListAdapter(ArrayList<PetNews> list,PetTrendsActivity context,Animal animal){
		...
		giftList=StringUtil.getGiftList(context,HandleHttpConnectionException.getInstance().getHandler(context));
