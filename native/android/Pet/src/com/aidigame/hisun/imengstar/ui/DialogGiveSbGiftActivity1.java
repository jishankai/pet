...
public class DialogGiveSbGiftActivity1 extends Activity{
	...
	private void loadData() {
		// TODO Auto-generated method stub
		InputStream in=null;
		ArrayList<Gift> list=StringUtil.getGiftList(context,handler);
		if(giftList!=null){
			this.giftList=list;
		}else{
		...
		if(PetApplication.myUser!=null){
			 new Thread(new Runnable() {
					...
					public void run() {
						// TODO Auto-generated method stub
						final ArrayList<Gift> temp1=HttpUtil.userItems(DialogGiveSbGiftActivity1.this,PetApplication.myUser, -1, handler);
