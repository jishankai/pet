...
import com.aidigame.hisun.imengstar.widget.fragment.AddressDialog;
import com.aidigame.hisun.imengstar.widget.fragment.AgeDialog;
import com.aidigame.hisun.imengstar.widget.fragment.NewUserCenterFragment;
import com.aidigame.hisun.imengstar.widget.fragment.RaceDialog;
 ...
 *
 */
public class ModifyPetInfoActivity extends BaseActivity {
									...
									runOnUiThread(new Runnable() {
										...
										public void run() {
											...
											if(NewUserCenterFragment.userCenterFragment!=null){
												NewUserCenterFragment.userCenterFragment.updatateInfo(true);;
											}
