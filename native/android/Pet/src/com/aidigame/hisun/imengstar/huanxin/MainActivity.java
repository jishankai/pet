...
import com.aidigame.hisun.imengstar.huanxin.InviteMessage.InviteMesageStatus;
...
//		EMGroupManager.getInstance().addGroupChangeListener(new MyGroupChangeListener());
	...
	public int getUnreadAddressCountTotal() {
		...
		if (com.aidigame.hisun.imengstar.PetApplication.getContactList().get(Constant.NEW_FRIENDS_USERNAME) != null)
			unreadAddressCountTotal = com.aidigame.hisun.imengstar.PetApplication.getContactList().get(Constant.NEW_FRIENDS_USERNAME).getUnreadMsgCount();
...
//			message.getStringAttribute("");
	...
	private class MyContactListener implements EMContactListener {
		...
		public void onContactAdded(List<String> usernameList) {
			// 保存增加的联系人
			Map<String, User> localUsers = com.aidigame.hisun.imengstar.PetApplication.getContactList();
	...
	private void saveInviteMsg(InviteMessage msg) {
		...
		// 未读数加1
		User user = com.aidigame.hisun.imengstar.PetApplication.getContactList().get(Constant.NEW_FRIENDS_USERNAME);
...
//			updateUnreadAddressLable();
	...
	private void showConflictDialog() {
		...
		com.aidigame.hisun.imengstar.PetApplication.logout(null);
