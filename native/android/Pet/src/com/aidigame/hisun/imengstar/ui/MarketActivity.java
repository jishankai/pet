...
import com.aidigame.hisun.imengstar.adapter.MarketGridViewAdapter.ClickGiftListener;
...
//					Toast.makeText(MarketActivity.this, "Sorry~余额不足(⊙o⊙)哦~", Toast.LENGTH_LONG).show();
				...
				new Thread(new Runnable() {
					...
					public void run() {
						// TODO Auto-generated method stub
						gift.buyingNum=1;
						final MyUser user=HttpUtil.buyGift(MarketActivity.this,gift, handler);
		...
		private void loadData() {
			// TODO Auto-generated method stub
			InputStream in=null;
			ArrayList<Gift> giftList=StringUtil.getGiftList(MarketActivity.this,handler);
			if(giftList!=null){
