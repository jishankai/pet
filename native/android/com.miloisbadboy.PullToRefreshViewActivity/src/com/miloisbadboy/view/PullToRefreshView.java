...
//	private ImageView mFooterImageView;
	...
	private OnHeaderPreRefreshListener mOnHeaderPreRefreshListener;
	/**
	 * last update time
	 */
...
//				.findViewById(R.id.pull_to_load_image);
	...
	private void headerPrepareToRefresh(int deltaY) {
		...
		if(mOnHeaderPreRefreshListener!=null){
			mOnHeaderPreRefreshListener.onHeaderPreRefresh(this);
		}
	}
...
//		mFooterImageView.setImageDrawable(null);
		mFooterProgressBar.setVisibility(View.VISIBLE);//mFooterProgressBar.setVisibility(View.VISIBLE);
	...
	public void onFooterRefreshComplete() {
		setHeaderTopMargin(-mHeaderViewHeight);
//		mFooterImageView.setVisibility(View.INVISIBLE);//mFooterImageView.setVisibility(View.VISIBLE);
//		mFooterImageView.setImageResource(R.drawable.ic_pulltorefresh_arrow_up);
	...
	public void setOnHeaderPreRefreshListener(
			OnHeaderPreRefreshListener headerPreRefreshListener) {
		mOnHeaderPreRefreshListener = headerPreRefreshListener;
	}
	...
	public interface OnHeaderPreRefreshListener {
		public void onHeaderPreRefresh(PullToRefreshView view);
	}
}
