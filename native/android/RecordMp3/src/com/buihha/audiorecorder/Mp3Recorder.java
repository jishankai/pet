...
public class Mp3Recorder {
	...
	private void initAudioRecorder() throws IOException {
		...
		String externalPath = Environment.getExternalStorageDirectory()+File.separator+"pet";
		...
		mp3File = new File(externalPath+File.separator, fileName);
		fileName=externalPath+File.separator+fileName;
