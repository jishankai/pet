...
class UserController extends Controller
{
    ...
    {
        $r = Yii::app()->db->createCommand('SELECT a.aid, a.name, a.tx, a.gender, u.name AS u_name, u.tx AS u_tx, a.t_rq, (SELECT COUNT(*) FROM dc_circle c WHERE c.aid=a.aid) AS fans FROM dc_animal a LEFT JOIN dc_user u ON a.master_id=u.usr_id ORDER BY a.t_rq DESC LIMIT :m,30')->bindValues(array(
            ':m'=>30*$page,
        ))->queryAll();
