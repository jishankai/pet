    ...
    public function actionRqRankApi($category=0)
    {
       switch ($category) {
           ...
           case 1:
               ...
               Yii::app()->cache->set('d_rq_rank', $rank, 3600*24);               
               break;
           ...
           case 2:
               ...
               Yii::app()->cache->set('w_rq_rank', $rank, 3600*24*7);               
               break;
           ...
           case 3:
               ...
               Yii::app()->cache->set('m_rq_rank', $rank, 3600*24*30);               
               break;
    ...
    public function actionContributionRankApi($aid, $category=0)
    {
       switch ($category) {
           ...
           case 1:
               ...
               Yii::app()->cache->set($aid.'_d_rank', $rank, 3600*24);               
               break;
           ...
           case 2:
               ...
               Yii::app()->cache->set($aid.'_w_rank', $rank, 3600*24*7);               
               break;
           ...
           case 3:
               ...
               Yii::app()->cache->set($aid.'_m_rank', $rank, 3600*24*30);               
               break;
