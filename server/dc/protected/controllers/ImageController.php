...
class ImageController extends Controller
{
    ...
    {
       $r = Yii::app()->db->createCommand('SELECT i.img_id, i.aid, i.cmt, i.food, i.create_time, a.name, a.tx, a.type, a.gender, u.usr_id, u.tx AS u_tx, u.name AS u_name  FROM dc_image i LEFT JOIN dc_animal a ON i.aid=a.aid LEFT JOIN dc_user u ON a.master_id=u.usr_id WHERE is_food=1 AND i.create_time>=:create_time ORDER BY i.create_time DESC LIMIT :m,30')->bindValues(array(':create_time'=> time()-(60*60*24), ':m'=>$page*30))->queryAll();
