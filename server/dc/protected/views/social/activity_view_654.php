    ...
    <script>
        ...
        document.addEventListener('WeixinJSBridgeReady', function onBridgeReady() {
            window.shareData = {
                ...
                "fContent": "宠物星球已经召集"+<?php echo $users?>+"位小伙伴为紫竹院喵募集年夜饭，下一位暖心小天使是你吗？",
                "wContent": "宠物星球已经召集"+<?php echo $users?>+"位小伙伴为紫竹院喵募集年夜饭，下一位暖心小天使是你吗？"
            };

        // 发送给好友
        WeixinJSBridge.on('menu:share:appmessage', function (argv) {
            WeixinJSBridge.invoke('sendAppMessage', {
                "img_url": "http://"+window.location.host+"/css/images/a5.jpg",
                "img_width": "401",
                "img_height": "275",
