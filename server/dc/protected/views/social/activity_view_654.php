...
<div class="act2_wrap comWidth">
	...
	<div class="act2_body">
		...
		<ul class="act2_imgBox clearfix" id="act2_imgBox">
			<li ><img src="css/img/zzy/1.png" alt="" name="1"></li>
			<li ><img src="css/img/zzy/2.png" alt="" name="2"></li>
			<li ><img src="css/img/zzy/3.png" alt="" name="3"></li>
			<li ><img src="css/img/zzy/4.png" alt="" name="4"></li>
			<li ><img src="css/img/zzy/5.png" alt="" name="5"></li>
			<li ><img src="css/img/zzy/6.png" alt="" name="6"></li>
