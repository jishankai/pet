...
<div class="act2_wrap comWidth">
	<div class="act2_top">
		...
		<div class="introduce">
			...
			<div class="pet_weibo">新浪微博：<span><a href="http://weibo.com/u/1883332187?topnav=1&wvr=6&topsug=1">税后五百万翻番</a></span></div>
		</div>
	...
	<div class="act2_body">
		...
		<ul class="act2_imgBox clearfix" id="act2_imgBox">
			...
			<li ><img src="css/img/bh/10.png" alt="" name="10"></li>
		</ul>
	</div>
...
<script type="text/javascript">
 ...
 $('#act2_imgBox img').tap(function(){
        ...
        var paddingTop = parseInt((winHeight - h)/2);*/
        ...
        /*$('#large_img').css("padding-top", paddingTop);*/
