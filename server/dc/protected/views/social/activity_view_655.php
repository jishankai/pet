...
<body>
<span id="dq" style="display:none">清华</span>
...
<div class="act2_wrap comWidth">
	<div class="act2_top">
        ...
        <div class="wb">
            <wb:publish action="publish" type="mobile" id="wb" language="zh_cn" button_type="red" button_size="small" button_text="暖冬季" uid="5252680717" default_text="快来和我一起为清华的流浪喵捐冬粮吧~http://t.cn/RZXneWv" tag="暖冬季•年夜饭计划" default_image="http%3A%2F%2Fkouliang.tuturead.com%2Fcss%2Fimg%2Fqh%2F9.jpg,http%3A%2F%2Fkouliang.tuturead.com%2Fcss%2Fimg%2Fqh%2F8.jpg,http%3A%2F%2Fkouliang.tuturead.com%2Fcss%2Fimg%2Fqh%2F7.jpg,http%3A%2F%2Fkouliang.tuturead.com%2Fcss%2Fimg%2Fqh%2F6.jpg,http%3A%2F%2Fkouliang.tuturead.com%2Fcss%2Fimg%2Fqh%2F5.jpg,http%3A%2F%2Fkouliang.tuturead.com%2Fcss%2Fimg%2Fqh%2F4.jpg,http%3A%2F%2Fkouliang.tuturead.com%2Fcss%2Fimg%2Fqh%2F3.jpg,http%3A%2F%2Fkouliang.tuturead.com%2Fcss%2Fimg%2Fqh%2F2.jpg,http%3A%2F%2Fkouliang.tuturead.com%2Fcss%2Fimg%2Fqh%2F1.jpg" appkey="392HpS" ></wb:publish>
        </div>
        <div class="the_more">
		...
		<div class="act2_range">
			...
			<div class="target_Box clearfix">
				<div class="target">超出目标<span class="target_num" id="target_num">99000</span>了 <span class="target_num" id="target_num"><?php echo $food-99000 ?></span> 份口粮</div>
				<!-- <div class="d_time" id="d_time"></div> -->
                <!-- <div class="target">目标<span class="target_num" id="target_num">99000</span>达成！</div> -->
                <div class="d_time">达成时间：2015年1月20日9时20分</div>
			</div>
			<div class="hr_10"></div>
			<div class="aprogressbar">
				<div class="abar" id="abar" style="width:<?php echo sprintf("%.2f",$food*100/99000)?>%"></div>
			</div>
		</div>
...
<script>
  ...
  wx.ready(function () {
    ...
    var shareData = {
        title: "清华喵年夜饭 大！募！集！",
        desc: "宠物星球已经召集"+<?php echo $users?>+"位小伙伴为清华喵募集年夜饭，下一位暖心小天使是你吗？",
        link: "http://"+window.location.host+"/index.php?r=social/activityview&aid="+<?php echo $aid?>, 
        imgUrl: "http://"+window.location.host+"/css/images/a6.jpg"
    };
