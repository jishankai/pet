		...
		<div class="head_imgBox">
			<ul class="head_imgList clearfix">
				<li style="position: relative">
					<img alt="" src="css/images/base_head1.JPG">
					<img src="css/images/photo-m-t.png" style="position: absolute;left:0;top:0px;z-index:1；">
				</li>
				<li style="position: relative">
					<img alt="" src="css/images/base_head2.JPG">
					<img src="css/images/photo-m-t.png" style="position: absolute;left:0;top:0px;z-index:1；">
				</li>
				<li style="position: relative">
					<img alt="" src="css/images/base_head3.JPG">
					<img src="css/images/photo-m-t.png" style="position: absolute;left:0;top:0px;z-index:1；">
				</li>
				<li style="position: relative">
					<img alt="" src="css/images/base_head4.JPG">
					<img src="css/images/photo-m-t.png" style="position: absolute;left:0;top:0px;z-index:1；">
				</li>
				<li style="position: relative">
					<img alt="" src="css/images/base_head5.JPG">
					<img src="css/images/photo-m-t.png" style="position: absolute;left:0;top:0px;z-index:1；">
				</li>
				<li style="position: relative">
					<img alt="" src="css/images/base_head6.JPG">
					<img src="css/images/photo-m-t.png" style="position: absolute;left:0;top:0px;z-index:1；">
				</li>
				<li style="position: relative">
					<img alt="" src="css/images/base_head7.JPG">
					<img src="css/images/photo-m-t.png" style="position: absolute;left:0;top:0px;z-index:1；">
				</li>
				<li>
					<img alt="" src="css/images/b_right.png" class="head_right">
				</li>
			</ul>
		</div>
