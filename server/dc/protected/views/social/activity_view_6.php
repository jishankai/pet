...
<div class="act2_wrap comWidth">
	<div class="act2_top">
		...
		<div class="introduce">
			<div class="pet_name">代粮喵：<span>小七monkey熊猫mickey</span></div>
			<div class="pet_place">代粮地点：<span>北京清华大学</span></div>
			<div class="pet_weibo">新浪微博：<span><a href="http://weibo.com/u/1411960057?topnav=1&wvr=6&topsug=1">扑倒所有喵</a></span></div>
		</div>
		<div class="declaration">活动宣言：<span>给清华大学的流浪喵们带来温暖的冬天！</span></div>
	...
	<div class="act2_body">
		...
		<ul class="act2_imgBox clearfix" id="act2_imgBox">
			...
			<li ><img src="css/img/qh/10.png" alt="" name="10"></li>
		</ul>
	</div>
