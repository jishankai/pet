    ...
    <script>
        ...
        document.addEventListener('WeixinJSBridgeReady', function onBridgeReady() {
            window.shareData = {
                ...
                "tTitle": "植物园喵年夜饭 大！募！集！",
                "tContent": "宠物星球已经召集"+<?php echo $users?>+"位小伙伴为植物园喵募集年夜饭，下一位暖心小天使是你吗？",
                "fTitle": "植物园喵年夜饭 大！募！集！",
                "fContent": "宠物星球已经召集"+<?php echo $users?>+"位小伙伴为植物园喵募集年夜饭，下一位暖心小天使是你吗？",
                "wContent": "宠物星球已经召集"+<?php echo $users?>+"位小伙伴为植物园喵募集年夜饭，下一位暖心小天使是你吗？"
            };

        // 发送给好友
        WeixinJSBridge.on('menu:share:appmessage', function (argv) {
            WeixinJSBridge.invoke('sendAppMessage', {
                "img_url": "http://"+window.location.host+"/css/images/a3.jpg",
                "img_width": "401",
                "img_height": "275",
	...
	<div class="act2_top">
		...
		<div class="act2_range">
			...
			<div class="target_Box clearfix">
				<div class="target">目标还剩 <span class="target_num" id="target_num"><?php echo 342000-$food ?></span> 份口粮</div>
