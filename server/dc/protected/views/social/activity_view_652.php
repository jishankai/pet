...
<div class="act2_wrap comWidth">
	<div class="act2_top">
        ...
        <div class="wb">
            <wb:publish action="publish" type="mobile" id="wb" language="zh_cn" button_type="red" button_size="small" button_text="暖冬季" uid="5252680717" default_text="快来和我一起为植物园的流浪喵捐冬粮吧~http://t.cn/RZXnY4H" tag="暖冬季•年夜饭计划" default_image="http%3A%2F%2Fkouliang.tuturead.com%2Fcss%2Fimg%2Fzwy%2F9.jpg,http%3A%2F%2Fkouliang.tuturead.com%2Fcss%2Fimg%2Fzwy%2F8.jpg,http%3A%2F%2Fkouliang.tuturead.com%2Fcss%2Fimg%2Fzwy%2F7.jpg,http%3A%2F%2Fkouliang.tuturead.com%2Fcss%2Fimg%2Fzwy%2F6.jpg,http%3A%2F%2Fkouliang.tuturead.com%2Fcss%2Fimg%2Fzwy%2F5.jpg,http%3A%2F%2Fkouliang.tuturead.com%2Fcss%2Fimg%2Fzwy%2F4.jpg,http%3A%2F%2Fkouliang.tuturead.com%2Fcss%2Fimg%2Fzwy%2F3.jpg,http%3A%2F%2Fkouliang.tuturead.com%2Fcss%2Fimg%2Fzwy%2F2.jpg,http%3A%2F%2Fkouliang.tuturead.com%2Fcss%2Fimg%2Fzwy%2F1.jpg" appkey="392HpS" ></wb:publish>
        </div>
        <div class="the_more">
		...
		<div class="act2_range">
			...
			<div class="target_Box clearfix">
				<div class="target">超出目标<span class="target_num" id="target_num">342000</span>了 <span class="target_num" id="target_num"><?php echo $food-342000 ?></span> 份口粮</div>
				<!-- <div class="d_time" id="d_time"></div> -->
			    <!-- <div class="target">目标<span class="target_num" id="target_num">342000</span>达成！</div> -->
	...
	<div class="act2_body">
		...
		<ul class="act2_imgBox clearfix" id="act2_imgBox">
			<li ><img src="css/img/zwy/1.jpg" alt="" name="1"></li>
			<li ><img src="css/img/zwy/2.jpg" alt="" name="2"></li>
			<li ><img src="css/img/zwy/3.jpg" alt="" name="3"></li>
			<li ><img src="css/img/zwy/4.jpg" alt="" name="4"></li>
			<li ><img src="css/img/zwy/5.jpg" alt="" name="5"></li>
			<li ><img src="css/img/zwy/6.jpg" alt="" name="6"></li>
			<li ><img src="css/img/zwy/7.jpg" alt="" name="7"></li>
			<li ><img src="css/img/zwy/8.jpg" alt="" name="8"></li>
			<li ><img src="css/img/zwy/9.jpg" alt="" name="9"></li>
		</ul>
...
<script>
  ...
  wx.ready(function () {
    ...
    var shareData = {
        title: "植物园喵年夜饭 大！募！集！",
        desc: "宠物星球已经召集"+<?php echo $users?>+"位小伙伴为植物园喵募集年夜饭，下一位暖心小天使是你吗？",
        link: "http://"+window.location.host+"/index.php?r=social/activityview&aid="+<?php echo $aid?>, 
        imgUrl: "http://"+window.location.host+"/css/images/a3.jpg"
    };
