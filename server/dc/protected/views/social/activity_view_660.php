...
<div class="act2_wrap comWidth">
	<div class="act2_top">
        ...
        <div class="wb">
            <wb:share-button appkey="392HpS" addition="simple" type="button" ralateUid="5252680717" default_text="北京动物园的流浪喵还差<?php echo 243000-$food?>份口粮才能温暖过冬呢~轻轻一点，免费捐粮！快来和我一起做爱心小天使~" pic="http%3A%2F%2Fkouliang.tuturead.com%2Fcss%2Fimages%2Fa4.jpg"></wb:share-button>
        </div>
        <div class="the_more">
	...
	<div class="act2_body">
		...
		<ul class="act2_imgBox clearfix" id="act2_imgBox">
			<li ><img src="css/img/dwy/1.jpg" alt="" name="1"></li>
			<li ><img src="css/img/dwy/2.jpg" alt="" name="2"></li>
			<li ><img src="css/img/dwy/3.jpg" alt="" name="3"></li>
			<li ><img src="css/img/dwy/4.jpg" alt="" name="4"></li>
			<li ><img src="css/img/dwy/5.jpg" alt="" name="5"></li>
			<li ><img src="css/img/dwy/6.jpg" alt="" name="6"></li>
			<li ><img src="css/img/dwy/7.jpg" alt="" name="7"></li>
			<li ><img src="css/img/dwy/8.jpg" alt="" name="8"></li>
			<li ><img src="css/img/dwy/9.jpg" alt="" name="9"></li>
		</ul>
...
<script>
  ...
  wx.ready(function () {
    ...
    var shareData = {
        title: "动物园喵年夜饭 大！募！集！",
        desc: "宠物星球已经召集"+<?php echo $users?>+"位小伙伴为动物园喵募集年夜饭，下一位暖心小天使是你吗？",
        link: "http://"+window.location.host+"/index.php?r=social/activityview&aid="+<?php echo $aid?>, 
        imgUrl: "http://"+window.location.host+"/css/images/a4.jpg"
    };
