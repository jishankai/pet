...
<head>
    ...
    <script type="text/ecmascript" src="assets/games/dcz/scripts/createjs.js"></script>
    <style type="text/css">
    body {font-family: "Helvetica Neue", Helvetica, STHeiTi, sans-serif; margin: 0; padding: 0;}
    .loading {background-image: url("data:assets/games/dcz/image/gif;base64,");
    ...
    .welcome-bg {position:absolute;top:0;left:0;right:0;bottom:0; background: url(assets/games/dcz/01.jpg) center center no-repeat; background-size:100% 100%; opacity: .4;overflow: hidden;}
    ...
    .t1,.t2,.t3,.t4,.t5 { background-size:auto 100%;background-image:url(assets/games/dcz/02.jpg);}
