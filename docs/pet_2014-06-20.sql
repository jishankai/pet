...
# Database: pet
# Generation Time: 2014-06-20 09:10:21 +0000
# ************************************************************
...
CREATE TABLE `dc_device` (
  ...
  `weibo` varchar(45) CHARACTER SET utf8 DEFAULT '',
  `wechat` varchar(45) CHARACTER SET utf8 DEFAULT NULL,
...
CREATE TABLE `dc_image` (
  ...
  `usr_id` int(10) unsigned NOT NULL,
  `topic` varchar(20) COLLATE utf8_bin DEFAULT NULL,
...
CREATE TABLE `dc_user` (
  ...
  `weibo` varchar(45) CHARACTER SET utf8 DEFAULT NULL,
  `wechat` varchar(45) CHARACTER SET utf8 DEFAULT NULL,
